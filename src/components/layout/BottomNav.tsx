...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-3 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-24px)] max-w-[520px]">
      <div className="grid grid-cols-4 gap-2 p-2.5 rounded-[26px] bg-[rgba(8,10,18,0.74)] border border-white/8 backdrop-blur-2xl shadow-[0_16px_50px_rgba(0,0,0,0.42)]">
        {TABS.map(tab => {
